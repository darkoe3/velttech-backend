...
from users.views import (
    ...
    InstructorLearningResourceDetailView,
    InstructorLearningResourcesView,
    InstructorNotificationsView,
    InstructorProgressReportsView,
    InstructorAssignmentsView,
    InstructorAssignmentDetailView,
    InstructorAssessmentGenerateLinkView,
    InstructorAssessmentResultApproveView,
    InstructorAssessmentResultCertificateEligibilityView,
    InstructorAssessmentResultDetailView,
    InstructorAssessmentResultImportQuizScoreView,
    InstructorAssessmentResultsView,
    InstructorAssessmentSharingView,
    InstructorSubmissionsView,
    InstructorGradeSubmissionView,
    InstructorStudentsView,
    InstructorPracticalGradeView,
    MyAssignmentsView,
    MyAssessmentResultsView,
    MyAttendanceView,
    MyLearningResourcesView,
    MyProgressView,
...
urlpatterns = [
    ...
    path('api/my-resources/', MyLearningResourcesView.as_view(), name='my-resources'),
    path('api/my-assessment-results/', MyAssessmentResultsView.as_view(), name='my-assessment-results'),
    ...
    path('api/instructor/resources/', InstructorLearningResourcesView.as_view(), name='instructor-resources'),
    path('api/instructor/resources/<int:pk>/', InstructorLearningResourceDetailView.as_view(), name='instructor-resource-detail'),
    path('api/instructor/progress-reports/', InstructorProgressReportsView.as_view(), name='instructor-progress-reports'),
    path('api/instructor/assessment-results/', InstructorAssessmentResultsView.as_view(), name='instructor-assessment-results'),
    path('api/instructor/assessment-results/<int:pk>/', InstructorAssessmentResultDetailView.as_view(), name='instructor-assessment-result-detail'),
    path('api/instructor/assessment-results/<int:pk>/import-quiz-score/', InstructorAssessmentResultImportQuizScoreView.as_view(), name='instructor-assessment-result-import-quiz-score'),
    path('api/instructor/assessment-results/<int:pk>/approve/', InstructorAssessmentResultApproveView.as_view(), name='instructor-assessment-result-approve'),
    path('api/instructor/assessment-results/<int:pk>/certificate-eligibility/', InstructorAssessmentResultCertificateEligibilityView.as_view(), name='instructor-assessment-result-certificate-eligibility'),
    ...
    path('api/instructor/assessments/<int:pk>/generate-link/', InstructorAssessmentGenerateLinkView.as_view(), name='instructor-assessment-generate-link'),
    path('api/instructor/assessments/<int:pk>/sharing/', InstructorAssessmentSharingView.as_view(), name='instructor-assessment-sharing'),
    ...
    path('api/public/assessment/<uuid:token>/', PublicAssessmentView.as_view(), name='public-assessment'),
